...
module.exports = Promise.resolve()
    ...
    .then(function () { return import('@theia/api-samples/lib/browser/api-samples-frontend-module').then(load) })
    .then(function () { return import('@theia/api-samples/lib/electron-browser/menu/sample-electron-menu-module').then(load) })
    .then(function () { return import('@theia/api-samples/lib/electron-browser/updater/sample-updater-frontend-module').then(load) })
    .then(function () { return import('@theia/external-terminal/lib/electron-browser/external-terminal-frontend-module').then(load) })
    ...
    .then(function () { return import('@theia/mini-browser/lib/electron-browser/environment/electron-mini-browser-environment-module').then(load) })
